...
const EditUserProfile = ({ uid}) => {
  ...
  return (
    <button
     className="flex items-center justify-center gap-3 text-blue-500 px-3 py-1.5 rounded-md hover:bg-blue-700 hover:text-white transition-colors duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed"
